...
var StyleAttributeWrapper = function(parent) {
    this.node = parent.style;
    this.nodeType = 2;
    this.nodeValue = parent.style.cssText;
    this.nodeName = 'style';
    this.parentNode = parent;
    this.ownerElement = parent;
    this.parentSourceIndex = parent.sourceIndex;
};
@*/
...
/*@cc_on @if (@_jscript)
        ...
        if (test.name == 'style') {
          if (node.style) {
            nodeset.push(new StyleAttributeWrapper(node));
            return nodeset;
          }
        }
@end @*/
